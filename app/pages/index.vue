...
async function getGlucoseData() {
    ...
    // data.value may be typed as unknown/empty; guard access
    const sgv = (data.value as { sgv?: number } | undefined)?.sgv;
    if (typeof sgv !== "number") {
        console.warn("Unexpected glucose data shape:", data.value);
        glucose.value = "-";
        glucoseColor.value = "";
        return;
    }
        ...
        <main>
            ...
            <section class="info-card">
                ...
                <div class="bottom">
                    ...
                    <ul class="social">
                        ...
                        <a href="https://discord.com/users/372343076578131968" target="_blank"
            ...
            <section class="projects-section">
                ...
                <div class="projects-list">
                    <div class="project-card" v-for="project in projects.slice(0, visibleProjectsCount)"
                        :key="project.id">
                        <h3>{{ project.title }}</h3>
