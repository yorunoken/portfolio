...
export default function Donations() {
    return (
        <section id="support" className="space-y-8">
            ...
            <div className="rounded-xl border border-white/5 bg-white/2 p-6 md:p-8 space-y-6">
                ...
                <div className="flex flex-wrap gap-3">
                    {wallets.map((wallet) => (
                        <a
                            ...
                            className="group inline-flex items-center justify-center gap-2 rounded-lg border border-white/10 bg-white/5 px-5 py-2.5 text-sm font-medium text-zinc-200 transition-all duration-300 hover:bg-white/10 hover:border-white/20 hover:text-white"
                        >
                            {wallet.name}
