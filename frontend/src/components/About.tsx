                ...
                <div className="md:col-span-2 space-y-6">
                    <div className="leading-relaxed space-y-4 text-zinc-300 text-base">
                        ...
                        <p>
                            ...
                            <a className="text-blue-300 hover:text-blue-200 transition-colors underline underline-offset-4 decoration-zinc-700" href="https://nightscout.yorunoken.com" target="_blank" rel="noopener noreferrer">
